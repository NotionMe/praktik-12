...
public class MainController {
  ...
  @FXML private ComboBox<String> choiceMouse;
  ...
  @FXML private TableView<Book> userTable;
  ...
  void onAdd(ActionEvent event) {
    try {
            ...
            if (dialogButton == addButton) {
              if (dialogController.validateInput()) {
                ...
                alert.setContentText(
                    "Будь ласка, перевірте, що рік, ціна та кількість сторінок є числами.");
                alert.showAndWait();
                return null;
              }
            }
                      ...
                      Platform.runLater(
                          () -> {
                            ...
                            successAlert.setContentText(
                                "Книга '"
                                    + book.getTitle()
                                    + "' була успішно додана до бази даних.");
                      ...
                      Platform.runLater(
                          () -> {
                            ...
                            errorAlert.setContentText(
                                "Сталася помилка при додаванні книги: " + throwable.getMessage());
      ...
      alert.setContentText(
          "Сталася помилка при завантаженні форми додавання книги: " + e.getMessage());
      alert.showAndWait();
    }
  }
    ...
    CompletableFuture.supplyAsync(
            () -> {
              ...
              switch (selectedField) {
                ...
                case "authorId":
                  try {
                    Integer authorId = Integer.parseInt(searchText);
                ...
                case "publisherId":
                  try {
                    Integer publisherId = Integer.parseInt(searchText);
                ...
                case "imagePath":
                  return bookRepository.findAll().stream()
                      .filter(
                          book ->
                              book.getImagePath() != null
                                  && book.getImagePath().contains(searchText))
  ...
  void initialize() {
    ...
    List<String> searchOptions =
        List.of("title", "authorId", "isbn", "publicationYear", "publisherId", "imagePath");
